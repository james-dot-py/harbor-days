...
import './lp-seal-feeding.js';   // SEAL FEEDING TIME at the Sea Lion Pool — keeper + fish toss + beggar-seal frenzy (task 118)
import './lp-heron-scope.js';    // SPOT THE NIGHT-HERON — scope on the Nature Boardwalk + session-camera eyepiece (task 118)
