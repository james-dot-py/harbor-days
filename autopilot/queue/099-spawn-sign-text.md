...
acceptance: >
  ...
  real-world sign text." The 'WHERE NEXT?' kiosk on the spawn plaza (tasks
  013/023). TEXT SWAP ONLY: replace the text content with game-related copy
  — a welcome/orientation message in the Ope! voice (e.g. pointing at the
  rocks, the harbor, and the L like the title card does). Do NOT alter the
